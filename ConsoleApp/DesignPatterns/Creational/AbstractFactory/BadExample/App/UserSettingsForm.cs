using ConsoleApp.DesignPatterns.Creational.AbstractFactory.BadExample.Mac;
using ConsoleApp.DesignPatterns.Creational.AbstractFactory.BadExample.Windows;

namespace ConsoleApp.DesignPatterns.Creational.AbstractFactory.BadExample.App;
